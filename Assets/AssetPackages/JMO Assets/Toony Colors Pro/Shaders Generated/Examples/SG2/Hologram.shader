...
Shader "Toony Colors Pro 2/Examples/SG2/Hologram"
{
	...
	SubShader
	{
		...
		float4 fragment_outline (v2f_outline input) : SV_Target
		{
			...
			// Shader Properties Sampling
			float4 __outlineColor = ( _OutlineColor.rgba );
