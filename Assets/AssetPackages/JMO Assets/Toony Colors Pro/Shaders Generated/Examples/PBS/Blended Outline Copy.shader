...
Shader "Toony Colors Pro 2/Examples/PBS/Blended Outline Copy"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf StandardTCP2 nofog keepalpha exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
